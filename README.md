### This repository contains code for the paper titled: 'Data-Driven Controller Synthesis via PAC-Guaranteed Finite Abstractions'
### Link: 
...
##### 1a. Visit here: https://github.com/ericskim/hscc18_modular/tree/hscc18_repeatability for the details on installation and usage of this modified version of tool SCOTS, and ensure the runningmax examples are working on your device.
...
##### 2. Ensure gurobi is installed on your device, and place the license file gurobi.lic in the directory where the .ipynb files can access. 
